 ...
 * @since     1.0.0
 */
class OrderOnWhatsappField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('order-on-whatsapp', 'OrderOnWhatsappField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'order-on-whatsapp/_components/fields/OrderOnWhatsappField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(OrderOnWhatsappFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').OrderOnWhatsappOrderOnWhatsappField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'order-on-whatsapp/_components/fields/OrderOnWhatsappField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
